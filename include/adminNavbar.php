...
<nav class="nav navbar">
	...
	<h5 class="my-0 mr-md-auto" style="font-weight:600">
		...
		<ul class="nav navbar-nav" style="width:60%;display:inline-block;font-size:16;font-weight:600; !important;">
			<li style="display:inline;margin-right:5px;"><a class="p-2 text-dark" href="../view/manageUser.php">Manage User</a></li>
			<li style="display:inline;margin-right:5px;"><a class="p-2 text-dark" href="../view/viewOrganizerRequest.php">Manage Courses</a></li>
